...
describe('ScrollingList', () => {
    ...
    it('shows gratitude editing view', () => {
        ...
        const tree = renderer.create(<ScrollingList entries={[]} editing={{ type: 'gratitude', onTextChange}} />)
    ...
    it('shows journal editing view', () => {
        const onTextChange = jest.fn()
        const tree = renderer.create(<ScrollingList entries={[]} editing={{ type: 'journal', onTextChange}} />)
        const listItem = tree.root.findByType(EditingListItem)
